 ...
 * @since 2.0
 */
public class ModeConditionEmbeddedTextValue extends EditableEmbeddedTextValue {
	/**
	 ...
	 */
	public ModeConditionEmbeddedTextValue(final BehaviorTransition behaviorTransition, final int originalSrcLength,
	...
	public boolean isValidModification(final EObject bo, final String newText) {
		if (bo instanceof BehaviorTransition) {
			final ModeCondition condition = ((BehaviorTransition) bo).getMode();
