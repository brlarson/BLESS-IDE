//DispatchConditionEmbeddedTextValue.java
 ...
 * @since 2.0
 */
public class DispatchConditionEmbeddedTextValue extends EditableEmbeddedTextValue {
	/**
	 ...
	 */
	public DispatchConditionEmbeddedTextValue(final BehaviorTransition behaviorTransition, final int originalSrcLength,
	...
	public String getEditDialogTitle() {
		return "Edit Dispatch Condition";
	}
	...
	public boolean isValidModification(final EObject bo, final String newText) {
		if (bo instanceof BehaviorTransition) {
			final DispatchCondition condition = ((BehaviorTransition) bo).getDispatch();
