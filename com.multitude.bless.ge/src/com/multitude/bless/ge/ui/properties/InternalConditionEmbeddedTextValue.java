 ...
 * @since 2.0
 */
public class InternalConditionEmbeddedTextValue extends EditableEmbeddedTextValue {
	/**
	 ...
	 */
	public InternalConditionEmbeddedTextValue(final BehaviorTransition behaviorTransition, final int originalSrcLength,
	...
	public String getEditDialogTitle() {
		return "Edit Mode Condition";
	}

	@Override
	public String getEditDialogMessage() {
		return "Enter new mode condition.";
	}
	...
	public boolean isValidModification(final EObject bo, final String newText) {
		if (bo instanceof BehaviorTransition) {
			final InternalCondition condition = ((BehaviorTransition) bo).getInternal();
