...
public class EditEmbeddedTextDialog extends MessageDialog {
	private static String WIDGET_ID = "com.multitude.bless.ge.behaviortransition.editdialog";
				...
				public void run() {
					Display.getDefault().asyncExec(() -> {
						if(!styledText.isDisposed()) {
							...
							// Source text to load
							final String modifiedSrc = newText; // xtextAdapter.getValidModifiedSource(newText).orElse(null);
