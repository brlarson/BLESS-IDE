 ...
 *
 */
public class BlessReferenceResolver implements ReferenceResolver {
	/**
	...
	public static class Factory implements ReferenceResolverFactory {
		...
		public ReferenceResolver create(final CreateReferenceResolverFactoryContext ctx) {
			return new BlessReferenceResolver();
		}
	}
	...
	public Optional<Object> resolve(final ResolveContext ctx) {
		...
		if (!BlessReferenceUtil.ANNEX_NAME.equalsIgnoreCase(name)) {
			return Optional.empty();
		}
		...
		if (index != null && index >= 0) {
			...
			return findParsedBehaviorAnnexSubclause(classifier, BlessReferenceUtil.ANNEX_NAME, index)
