...
public class UnitAnnexLinkingService implements AnnexLinkingService {
  @Inject
  ...
  public UnitAnnexLinkingService() {
  ...
  public List<EObject> resolveAnnexReference(final String annexName, final EObject context, final EReference reference, final INode node) {
    boolean _equalsIgnoreCase = annexName.equalsIgnoreCase("Unit");
