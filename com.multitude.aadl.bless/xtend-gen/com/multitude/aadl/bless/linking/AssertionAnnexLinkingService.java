...
public class AssertionAnnexLinkingService implements AnnexLinkingService {
  @Inject
  ...
  public AssertionAnnexLinkingService() {
  ...
  public List<EObject> resolveAnnexReference(final String annexName, final EObject context, final EReference reference, final INode node) {
    boolean _equalsIgnoreCase = annexName.equalsIgnoreCase("Assertion");
