...
public class ActionAnnexLinkingService implements AnnexLinkingService {
  @Inject
  ...
  public ActionAnnexLinkingService() {
  ...
  protected ILinkingService getLinkingService() {
    if ((this.linkingService == null)) {
      BlessControl.println("ActionAnnexLinkingService did not get injected ILinkingService");
    }
  ...
  protected IQualifiedNameProvider getNameProvider() {
    if ((this.nameProvider == null)) {
      BlessControl.println("ActionAnnexLinkingService did not get injected IQualifiedNameProvider");
    }
  ...
  protected ResourceDescriptionsProvider getResourceDescriptionsProvider() {
    if ((this.rdp == null)) {
      BlessControl.println("ActionAnnexLinkingService did not get injected ResourceDescriptionsProvider");
    }
    return this.rdp;
  }
  ...
  public List<EObject> resolveAnnexReference(final String annexName, final EObject context, final EReference reference, final INode node) {
    boolean _equalsIgnoreCase = annexName.equalsIgnoreCase("Action");
