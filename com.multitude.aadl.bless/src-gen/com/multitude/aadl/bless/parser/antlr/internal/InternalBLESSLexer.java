...
public class InternalBLESSLexer extends Lexer {
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBLESS.g:13902:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalBLESS.g:13902:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalBLESS.g:13902:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt1=0;
            loop1:
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBLESS.g:13904:17: ( '--' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalBLESS.g:13904:19: '--' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("--"); 

            // InternalBLESS.g:13904:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_DIGIT() throws RecognitionException {
        try {
            // InternalBLESS.g:13906:21: ( '0' .. '9' )
            // InternalBLESS.g:13906:23: '0' .. '9'
            {
            matchRange('0','9'); 
    ...
    public final void mRULE_NUMBER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBLESS.g:13908:13: ( ( '-' )? ( RULE_DIGIT )+ ( '.' ( RULE_DIGIT )+ ( 'e' ( '-' )? ( RULE_DIGIT )+ )? )? ( 'i' ( '-' )? ( RULE_DIGIT )+ ( '.' ( RULE_DIGIT )+ ( 'e' ( '-' )? ( RULE_DIGIT )+ )? )? )? )
            // InternalBLESS.g:13908:15: ( '-' )? ( RULE_DIGIT )+ ( '.' ( RULE_DIGIT )+ ( 'e' ( '-' )? ( RULE_DIGIT )+ )? )? ( 'i' ( '-' )? ( RULE_DIGIT )+ ( '.' ( RULE_DIGIT )+ ( 'e' ( '-' )? ( RULE_DIGIT )+ )? )? )?
            {
            // InternalBLESS.g:13908:15: ( '-' )?
            int alt5=2;
            ...
            // InternalBLESS.g:13908:20: ( RULE_DIGIT )+
            int cnt6=0;
            loop6:
            do {
                int alt6=2;
            ...
            // InternalBLESS.g:13908:32: ( '.' ( RULE_DIGIT )+ ( 'e' ( '-' )? ( RULE_DIGIT )+ )? )?
            int alt11=2;
            ...
            switch (alt11) {
                case 1 :
                    // InternalBLESS.g:13908:33: '.' ( RULE_DIGIT )+ ( 'e' ( '-' )? ( RULE_DIGIT )+ )?
                    {
                    match('.'); 
                    // InternalBLESS.g:13908:37: ( RULE_DIGIT )+
                    int cnt7=0;
                    loop7:
                    do {
                        int alt7=2;
                    ...
                    // InternalBLESS.g:13908:49: ( 'e' ( '-' )? ( RULE_DIGIT )+ )?
                    int alt10=2;
                    ...
                    switch (alt10) {
                        case 1 :
                            // InternalBLESS.g:13908:50: 'e' ( '-' )? ( RULE_DIGIT )+
                            {
                            match('e'); 
                            // InternalBLESS.g:13908:54: ( '-' )?
                            int alt8=2;
                            ...
                            // InternalBLESS.g:13908:59: ( RULE_DIGIT )+
                            int cnt9=0;
                            loop9:
                            do {
                                int alt9=2;
            ...
            // InternalBLESS.g:13908:75: ( 'i' ( '-' )? ( RULE_DIGIT )+ ( '.' ( RULE_DIGIT )+ ( 'e' ( '-' )? ( RULE_DIGIT )+ )? )? )?
            int alt19=2;
            ...
            switch (alt19) {
                case 1 :
                    // InternalBLESS.g:13908:76: 'i' ( '-' )? ( RULE_DIGIT )+ ( '.' ( RULE_DIGIT )+ ( 'e' ( '-' )? ( RULE_DIGIT )+ )? )?
                    {
                    match('i'); 
                    // InternalBLESS.g:13908:80: ( '-' )?
                    int alt12=2;
                    ...
                    // InternalBLESS.g:13908:85: ( RULE_DIGIT )+
                    int cnt13=0;
                    loop13:
                    do {
                        int alt13=2;
                    ...
                    // InternalBLESS.g:13908:97: ( '.' ( RULE_DIGIT )+ ( 'e' ( '-' )? ( RULE_DIGIT )+ )? )?
                    int alt18=2;
                    ...
                    switch (alt18) {
                        case 1 :
                            // InternalBLESS.g:13908:98: '.' ( RULE_DIGIT )+ ( 'e' ( '-' )? ( RULE_DIGIT )+ )?
                            {
                            match('.'); 
                            // InternalBLESS.g:13908:102: ( RULE_DIGIT )+
                            int cnt14=0;
                            loop14:
                            do {
                                int alt14=2;
                            ...
                            // InternalBLESS.g:13908:114: ( 'e' ( '-' )? ( RULE_DIGIT )+ )?
                            int alt17=2;
                            ...
                            switch (alt17) {
                                case 1 :
                                    // InternalBLESS.g:13908:115: 'e' ( '-' )? ( RULE_DIGIT )+
                                    {
                                    match('e'); 
                                    // InternalBLESS.g:13908:119: ( '-' )?
                                    int alt15=2;
                                    ...
                                    // InternalBLESS.g:13908:124: ( RULE_DIGIT )+
                                    int cnt16=0;
                                    loop16:
                                    do {
                                        int alt16=2;
    ...
    public final void mRULE_LETTER() throws RecognitionException {
        try {
            // InternalBLESS.g:13910:22: ( ( 'a' .. 'z' | 'A' .. 'Z' ) )
            // InternalBLESS.g:13910:24: ( 'a' .. 'z' | 'A' .. 'Z' )
            {
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBLESS.g:13912:13: ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"' )
            // InternalBLESS.g:13912:15: '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
            {
            match('\"'); 
            // InternalBLESS.g:13912:19: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )*
            loop20:
            do {
                int alt20=3;
                ...
                switch (alt20) {
            	case 1 :
            	    // InternalBLESS.g:13912:20: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\\\' )
            	    {
            	    match('\\'); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBLESS.g:13914:9: ( RULE_LETTER ( ( '_' )? ( RULE_LETTER | '0' .. '9' ) )* )
            // InternalBLESS.g:13914:11: RULE_LETTER ( ( '_' )? ( RULE_LETTER | '0' .. '9' ) )*
            {
            mRULE_LETTER(); 
            // InternalBLESS.g:13914:23: ( ( '_' )? ( RULE_LETTER | '0' .. '9' ) )*
            loop22:
            do {
                int alt22=2;
                ...
                switch (alt22) {
            	case 1 :
            	    // InternalBLESS.g:13914:24: ( '_' )? ( RULE_LETTER | '0' .. '9' )
            	    {
            	    // InternalBLESS.g:13914:24: ( '_' )?
            	    int alt21=2;
    ...
    public final void mRULE_DOTDOT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBLESS.g:13916:13: ( '..' )
            // InternalBLESS.g:13916:15: '..'
            {
            match(".."); 
    ...
    public final void mRULE_COMMADOT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBLESS.g:13918:15: ( ',.' )
            // InternalBLESS.g:13918:17: ',.'
            {
            match(",."); 
    ...
    public final void mRULE_DOTCOMMA() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBLESS.g:13920:15: ( '.,' )
            // InternalBLESS.g:13920:17: '.,'
            {
            match(".,"); 
    ...
    public final void mRULE_COMMACOMMA() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBLESS.g:13922:17: ( ',,' )
            // InternalBLESS.g:13922:19: ',,'
            {
            match(",,"); 
