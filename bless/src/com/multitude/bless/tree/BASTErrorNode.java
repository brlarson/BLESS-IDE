...
/**
 * BASTErrorNode is used in place of CommonErrorNode by BASTTreeAdaptor
 * 
 * @author brl
 * 
 */
public class BASTErrorNode extends BAST
{
...
public BASTErrorNode(TokenStream input, Token start, Token stop,
		RecognitionException e)
	{
	// Dump.it("start: "+start+", stop: "+stop);
	if (stop == null
...
public String toString()
	...
	if (trappedException instanceof MissingTokenException)
		...
		{
		return "<mismatched token: " + trappedException.token + ", resync="
				+ getText() + ">";
		}
