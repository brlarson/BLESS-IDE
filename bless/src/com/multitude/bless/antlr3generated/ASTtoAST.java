// $ANTLR 3.5.2 /Users/brianlarson/git2/BLESS-IDE/bless/Grammars/ASTtoAST.g 2023-04-01 20:11:37
...
public class ASTtoAST extends TreeParser {
		...
		try {
				...
				if ( (LA1_1==DOWN) ) {
					...
					if ( (LA1_3==ID) ) {
						...
						if ( (LA1_4==UP) ) {
							...
							if ( ((LA1_5 >= AADL_STRING_LITERAL && LA1_5 <= 299)) ) {
								alt1=1;
							}
						}
					}
			...
			if ( (LA2_0==PARAMETERS) ) {
				...
				if ( (LA2_1==DOWN) ) {
					...
					if ( ((LA2_3 >= AADL_STRING_LITERAL && LA2_3 <= 299)) ) {
						...
						if ( (LA2_4==DOWN) ) {
							...
							if ( ((LA2_6 >= AADL_STRING_LITERAL && LA2_6 <= 299)) ) {
								alt2=1;
							}
						}
					}
				...
				case 1 :
					...
					if ( input.LA(1)==Token.DOWN ) {
						...
						while (true) {
							...
							if ( ((LA3_0 >= AADL_STRING_LITERAL && LA3_0 <= 299)) ) {
								alt3=1;
							}
							else if ( (LA3_0==UP) ) {
								alt3=2;
			...
			switch (alt6) {
				case 1 :
					...
					while (true) {
						...
						if ( ((LA5_0 >= AADL_STRING_LITERAL && LA5_0 <= 299)) ) {
							alt5=1;
						}
						else if ( (LA5_0==UP) ) {
							alt5=2;
				...
				case ACTION:
					...
					if ( (LA7_1==DOWN) ) {
						...
						if ( (LA7_6==P) ) {
							...
							if ( ((LA7_10 >= UP && LA7_10 <= 299)) ) {
								alt7=1;
							}
						}
						else if ( ((LA7_6 >= AADL_STRING_LITERAL && LA7_6 <= ON)||(LA7_6 >= PARAMETER && LA7_6 <= 299)) ) {
							alt7=1;
						}
					}
				...
				case SEMICOLON:
					...
					if ( (LA7_2==DOWN) ) {
						...
						if ( (LA7_7==ACTION) ) {
							...
							if ( ((LA7_11 >= UP && LA7_11 <= 299)) ) {
								alt7=1;
							}
						}
						else if ( ((LA7_7 >= AADL_STRING_LITERAL && LA7_7 <= AADL_STRING_PART)||(LA7_7 >= ACTION_SUBCLAUSE && LA7_7 <= 299)) ) {
							alt7=1;
						}
					}
			...
			switch (alt14) {
				case 1 :
					...
					if ( input.LA(1)==Token.DOWN ) {
						...
						if ( ((LA8_0 >= AADL_STRING_LITERAL && LA8_0 <= 299)) ) {
							alt8=1;
						}
						switch (alt8) {
							case 1 :
					...
					if ( input.LA(1)==Token.DOWN ) {
						...
						if ( ((LA9_0 >= AADL_STRING_LITERAL && LA9_0 <= 299)) ) {
							alt9=1;
						}
						switch (alt9) {
							case 1 :
				...
				case 2 :
					...
					if ( input.LA(1)==Token.DOWN ) {
						...
						if ( ((LA10_0 >= AADL_STRING_LITERAL && LA10_0 <= 299)) ) {
							alt10=1;
						}
						switch (alt10) {
							case 1 :
					...
					if ( input.LA(1)==Token.DOWN ) {
						...
						if ( ((LA11_0 >= AADL_STRING_LITERAL && LA11_0 <= 299)) ) {
							alt11=1;
						}
						switch (alt11) {
							case 1 :
					...
					while (true) {
						...
						if ( ((LA12_0 >= AADL_STRING_LITERAL && LA12_0 <= 299)) ) {
							alt12=1;
						}
						else if ( (LA12_0==UP) ) {
							alt12=2;
				...
				case ACTION:
					...
					if ( (LA15_1==DOWN) ) {
						...
						if ( (LA15_6==P) ) {
							...
							if ( ((LA15_10 >= UP && LA15_10 <= 299)) ) {
								alt15=1;
							}
						}
						else if ( ((LA15_6 >= AADL_STRING_LITERAL && LA15_6 <= ON)||(LA15_6 >= PARAMETER && LA15_6 <= 299)) ) {
							alt15=1;
						}
					}
				...
				case SEMICOLON:
					...
					if ( (LA15_2==DOWN) ) {
						...
						if ( (LA15_7==ACTION) ) {
							...
							if ( ((LA15_11 >= UP && LA15_11 <= 299)) ) {
								alt15=1;
							}
						}
						else if ( ((LA15_7 >= AADL_STRING_LITERAL && LA15_7 <= AADL_STRING_PART)||(LA15_7 >= ACTION_SUBCLAUSE && LA15_7 <= 299)) ) {
							alt15=1;
						}
					}
		...
		try {
			...
			if ( (LA16_0==ASSERTION) ) {
				...
				if ( (LA16_1==DOWN) ) {
					...
					if ( (LA16_2==LABEL) ) {
						...
						if ( (LA16_3==DOWN) ) {
							...
							if ( (LA16_5==ID) ) {
									...
									case PARAMETERS:
										...
										if ( (LA16_8==DOWN) ) {
											...
											case TILDE:
												...
												else if ( ((LA16_11 >= UP && LA16_11 <= 299)) ) {
													alt16=2;
												}
											...
											case COMMA:
												...
												else if ( ((LA16_12 >= UP && LA16_12 <= 299)) ) {
													alt16=2;
												}
								...
								else if ( ((LA16_6 >= AADL_STRING_LITERAL && LA16_6 <= 299)) ) {
									alt16=3;
								}
							...
							else if ( ((LA16_5 >= AADL_STRING_LITERAL && LA16_5 <= HEX_DIGIT)||(LA16_5 >= IMP && LA16_5 <= 299)) ) {
								alt16=3;
							}
					...
					else if ( ((LA16_2 >= AADL_STRING_LITERAL && LA16_2 <= IP_PRED)||(LA16_2 >= LASS && LA16_2 <= 299)) ) {
						alt16=3;
					}
			...
			switch (alt16) {
				case 1 :
					...
					// AST REWRITE
					// elements: a, ass, formals, p, par, l
			...
			switch (alt25) {
				case 1 :
					...
					if ( input.LA(1)==Token.DOWN ) {
						...
						if ( ((LA19_0 >= AADL_STRING_LITERAL && LA19_0 <= 299)) ) {
							alt19=1;
						}
						switch (alt19) {
							case 1 :
					...
					if ( input.LA(1)==Token.DOWN ) {
						...
						if ( ((LA20_0 >= AADL_STRING_LITERAL && LA20_0 <= 299)) ) {
							alt20=1;
						}
						switch (alt20) {
							case 1 :
					...
					while (true) {
						...
						case 1 :
							...
							if ( input.LA(1)==Token.DOWN ) {
								...
								if ( ((LA21_0 >= AADL_STRING_LITERAL && LA21_0 <= 299)) ) {
									alt21=1;
								}
								switch (alt21) {
									case 1 :
							...
							if ( input.LA(1)==Token.DOWN ) {
								...
								if ( ((LA22_0 >= AADL_STRING_LITERAL && LA22_0 <= 299)) ) {
									alt22=1;
								}
								switch (alt22) {
									case 1 :
	...
	public final ASTtoAST.get_invariant_from_bless_subclause_return get_invariant_from_bless_subclause() throws RecognitionException {
		...
		try {
			...
			while (true) {
				...
				if ( ((LA27_0 >= AADL_STRING_LITERAL && LA27_0 <= 299)) ) {
					alt27=1;
				}
				else if ( (LA27_0==UP) ) {
					alt27=2;
			...
			while (true) {
				...
				if ( ((LA28_0 >= AADL_STRING_LITERAL && LA28_0 <= 299)) ) {
					alt28=1;
				}
				else if ( (LA28_0==UP) ) {
					alt28=2;
	...
	public static final BitSet FOLLOW_RCURLY_in_getBehaviorActionsFromELQ167 = new BitSet(new long[]{0x0000000000000008L,0x0000020000000000L});
	...
	public static final BitSet FOLLOW_getPreconditionFromBehaviorActions_in_getPreconditionFromBehaviorActionsInELQ218 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000400L});
	...
	public static final BitSet FOLLOW_getPreconditionFromBehaviorActions_in_getPreconditionFromBehaviorActions374 = new BitSet(new long[]{0x0000000000000448L,0x0000000000004000L,0x0000000000000000L,0x0000000000000000L,0x0000000000010000L});
	...
	public static final BitSet FOLLOW_getPostconditionFromBehaviorActions_in_getPostconditionFromBehaviorActionsInELQ452 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000000000400L});
	...
	public static final BitSet FOLLOW_variable_in_variableList681 = new BitSet(new long[]{0x0000000000000008L,0x0000000000000000L,0x0000000000000000L,0x0000000000000000L,0x0000000002000000L});
	public static final BitSet FOLLOW_TILDE_in_variable702 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_ID_in_variable706 = new BitSet(new long[]{0xFFFFFFFFFFFFFFF0L,0xFFFFFFFFFFFFFFFFL,0xFFFFFFFFFFFFFFFFL,0xFFFFFFFFFFFFFFFFL,0x00000FFFFFFFFFFFL});
	...
	public static final BitSet FOLLOW_getPostconditionFromBehaviorActions_in_getPostconditionFromBehaviorActions895 = new BitSet(new long[]{0x0000000000000448L,0x0000000000004000L,0x0000000000000000L,0x0000000000000000L,0x0000000000010000L});
	...
	public static final BitSet FOLLOW_DO_NOT_PROVE_in_get_invariant_from_bless_subclause979 = new BitSet(new long[]{0x0000000000000000L,0x0000000100000000L});
